...
public class ConceptsNotFoundException extends Exception {
    ...
    public ConceptsNotFoundException(String message) {
        super(message);
    }

    public ConceptsNotFoundException(Throwable cause) {
        super(cause);
    }

    public ConceptsNotFoundException(String message, Throwable cause) {
        super(message, cause);
    }
