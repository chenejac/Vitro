...
public class JaiImageProcessor extends IIOImageProcessor {
    ...
    public void startup(Application application, ComponentStartupStatus ss) {
        log.warn(
            "JaiImageProcessor is deprecated and will be removed - please update config/applicationSetup.n3 to use edu.cornell.mannlib.vitro.webapp.imageprocessor.imageio.IIOImageProcessor");
