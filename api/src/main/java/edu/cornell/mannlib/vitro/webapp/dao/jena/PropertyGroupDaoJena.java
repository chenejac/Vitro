                    ...
                    try {
                        for (Iterator stmtIt = closeIt; stmtIt.hasNext(); ) {
                            ...
                            if (subjRes.canAs(org.apache.jena.ontology.ObjectProperty.class)) {
                                ...
                                .canAs(org.apache.jena.ontology.DatatypeProperty.class)) {
    ...
    public void updatePropertyGroup(PropertyGroup group) {
        ...
        try {
            ...
            try {
                ...
                if (group.getPublicDescription() != null &&
                    group.getPublicDescription().length() > 0) {
                    groupInd.addProperty(PUBLIC_DESCRIPTION_ANNOT, group.getPublicDescription(),
                        XSDDatatype.XSDstring);
                }
            } catch (Exception e) {
            ...
            try {
                ...
                groupInd.addProperty(DISPLAY_RANK, Integer.toString(group.getDisplayRank()),
                    XSDDatatype.XSDint);
            } catch (Exception e) {
