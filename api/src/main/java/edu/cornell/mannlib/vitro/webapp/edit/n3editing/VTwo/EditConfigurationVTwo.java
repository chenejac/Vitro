...
public class EditConfigurationVTwo {
    ...
    private List<ModelChangePreprocessor> modelChangePreprocessors =
        new LinkedList<ModelChangePreprocessor>();
    ...
    public static void clearEditConfigurationInSession(HttpSession session,
                                                       EditConfigurationVTwo editConfig) {
        if (session == null || editConfig == null) {
            return;
        }
        Map<String, EditConfigurationVTwo> configs =
            (Map<String, EditConfigurationVTwo>) session.getAttribute("EditConfigurations");
        if (configs == null) {
            return;
        }
    ...
    public static void putConfigInSession(EditConfigurationVTwo ec, HttpSession sess) {
        ...
        Map<String, EditConfigurationVTwo> configs =
            (Map<String, EditConfigurationVTwo>) sess.getAttribute("EditConfigurations");
        if (configs == null) {
     ...
     */
    public static EditConfigurationVTwo getConfigFromSession(HttpSession sess,
    ...
    public void addSystemValues(Model model, HttpServletRequest request, ServletContext context) {
        ...
        if (getSparqlForAdditionalLiteralsInScope() != null &&
            ...
            dateLiterals
                .add(ResourceFactory.createTypedLiteral(formattedDate, XSDDatatype.XSDdateTime));
    ...
    public void prepareForDataPropUpdate(Model model, DataPropertyDao dataPropertyDao) {
        ...
        if (isObjectResource()) {
            ...
            throw new Error(
                "This request does not appear to be for an update since it lacks a dataProp hash key ");
        }
    ...
    public FieldVTwo getField(String key) {
        if (fields == null) {
            throw new Error(
                "hashmap of field objects must be set before you can get a value from the EditConfiguration");
        }
    ...
    public void setN3Required(String... n3RequiredStrs) {
        this.n3Required = new ArrayList<String>(
            Arrays.asList(n3RequiredStrs)); //using ArrayList to allow list to be resized
    }
    ...
    public void setN3Optional(String... n3Strs) {
        this.n3Optional = new ArrayList<String>(
            Arrays.asList(n3Strs)); //using ArrayList to allow list to be resized
    }
    ...
    public void setUrisOnForm(String... strs) {
        this.urisOnform =
            new ArrayList<String>(Arrays.asList(strs)); //using ArrayList to allow resizing
    }
    ...
    public void setSparqlForAdditionalLiteralsInScope(
