...
public class URLRewritingHttpServletResponse
    extends HttpServletResponseWrapper/*implements HttpServletResponse */ {
    ...
    public URLRewritingHttpServletResponse(HttpServletResponse response, HttpServletRequest request,
    ...
    public String encodeURL(String inUrl) {
        List<String> externallyLinkedNamespaces =
            wadf.getApplicationDao().getExternallyLinkedNamespaces();
        ...
        try {
            ...
            if ("individual".equals(url.pathParts.get(url.pathParts.size() - 1))) {
                ...
                while (qpIt.hasNext()) {
                    ...
                    qpIndex++;
                    if (("uri".equals(keyAndValue[0])) && (keyAndValue.length > 1) &&
                        (keyAndValue[1] != null)) {
                        try {
