...
public class Properties2PropertiesOperationController extends
    ...
    private static final Log log =
        LogFactory.getLog(Properties2PropertiesOperationController.class.getName());
    ...
    private void doEdit(String modeStr, boolean operation, VitroRequest request) {
        ...
        if (operation == REMOVE) {
            ...
            if (modeStr.equals("equivalentProperty")) {
                opDao.addEquivalentProperty(request.getParameter("SuperpropertyURI"),
                    request.getParameter("SubpropertyURI"));
            } else {
                opDao.addSuperproperty(request.getParameter("SubpropertyURI"),
                    request.getParameter("SuperpropertyURI"));
            }
        }
