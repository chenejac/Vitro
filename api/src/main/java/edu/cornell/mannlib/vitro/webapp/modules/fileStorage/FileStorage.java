...
public interface FileStorage extends Application.Module {
     ...
     *
     * @throws FileAlreadyExistsException if a file already exists with this ID but with a different
     *                                    filename.
     */
     ...
     * with it.
     *
     * @throws FileNotFoundException if there is no file that matches this ID and filename.
     */
