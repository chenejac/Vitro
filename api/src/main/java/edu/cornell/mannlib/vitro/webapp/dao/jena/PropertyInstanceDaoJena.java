...
public class PropertyInstanceDaoJena extends PropertyDaoJena implements
    ...
    public void deleteObjectPropertyStatement(String subjectURI, String propertyURI,
                                              String objectURI) {
            ...
            if ((subjRes != null) && (pred != null) && (objRes != null)) {
                ...
                if (invPred != null) {
                    ...
                    try {
                        ...
                        baseModel
                            .notifyEvent(new IndividualUpdateEvent(userUri, false, subjectURI));
                    }
                }
            }
        } finally {
    ...
    public Collection<PropertyInstance> getExistingProperties(String entityURI,
        ...
        for (edu.cornell.mannlib.vitro.webapp.beans.ObjectProperty op : ent
    ...
    public PropertyInstance getProperty(String subjectURI, String predicateURI, String objectURI) {
        ...
        pi.setPropertyName(
            getWebappDaoFactory().getObjectPropertyDao().getObjectPropertyByURI(predicateURI)
                .getDomainPublic());
        ;
    ...
    public void deletePropertyInstance(PropertyInstance prop) {
        this.deleteObjectPropertyStatement(prop.getSubjectEntURI(), prop.getPropertyURI(),
            prop.getObjectEntURI());
    }
