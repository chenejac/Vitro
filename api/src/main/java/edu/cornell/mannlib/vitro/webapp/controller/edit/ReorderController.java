...
public class ReorderController extends VitroAjaxController {
    ...
    private void reorderIndividuals(String[] individualUris, VitroRequest vreq,
                                    String rankPredicate) {
        ...
        for (String individualUri : individualUris) {
            ...
            retractions.add(writeModel
                .listStatements(individualResource, rankPredicateProperty, (RDFNode) null));
            ...
            if (datapropURI != null && datapropURI.length() > 0) {
                dataLiteral = ResourceFactory.createTypedLiteral(String.valueOf(counter),
                    TypeMapper.getInstance().getSafeTypeByName(datapropURI));
            } else {
