...
public class TBoxInferencesAccumulator {
    ...
    private static final Property RDFS_TYPE =
        createProperty("http://www.w3.org/1999/02/22-rdf-syntax-ns#type");
    private static final Resource OWL_CLASS = createResource("http://www.w3.org/2002/07/owl#Class");
    private static final Property OWL_EQUIVALENT_CLASS =
        createProperty("http://www.w3.org/2002/07/owl#equivalentClass");
    private static final Property OWL_DISJOINT_WITH =
        createProperty("http://www.w3.org/2002/07/owl#disjointWith");
    private static final Property OWL_SUBCLASS_OF =
        createProperty("http://www.w3.org/2000/01/rdf-schema#subClassOf");
    private static final Property OWL_SUBPROPERTY_OF =
        createProperty("http://www.w3.org/2000/01/rdf-schema#subPropertyOf");
    private static final Property OWL_INVERSE_OF =
    ...
    private static final Resource OWL_OBJECT_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#ObjectProperty");
    private static final Resource OWL_TOP_OBJECT_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#topObjectProperty");
    private static final Resource OWL_BOTTOM_OBJECT_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#bottomObjectProperty");
    private static final Resource OWL_DATA_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#DatatypeProperty");
    private static final Resource OWL_TOP_DATA_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#topDataProperty");
    private static final Resource OWL_BOTTOM_DATA_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#bottomDataProperty");
    private static final Resource OWL_FUNCTIONAL_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#FunctionalProperty");
    private static final Resource OWL_INVERSE_FUNCTIONAL_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#InverseFunctionalProperty");
    private static final Resource OWL_TRANSITIVE_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#TransitiveProperty");
    private static final Resource OWL_SYMMETRIC_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#SymmetricProperty");
    private static final Resource OWL_ASYMMETRIC_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#AsymmetricProperty");
    private static final Resource OWL_REFLEXIVE_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#ReflexiveProperty");
    private static final Resource OWL_IRREFLEXIVE_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#IrreflexiveProperty");
    private static final Resource OWL_ANNOTATION_PROPERTY =
        createResource("http://www.w3.org/2002/07/owl#AnnotationProperty");
    private static final Resource OWL_VERSION_INFO =
        createResource("http://www.w3.org/2002/07/owl#versionInfo");
    private static final Resource OWL_BACKWARD_COMPATIBLE_WITH =
        createResource("http://www.w3.org/2002/07/owl#backwardCompatibleWith");
    private static final Resource OWL_INCOMPATIBLE_WITH =
        createResource("http://www.w3.org/2002/07/owl#incompatibleWith");
    private static final Resource OWL_PRIOR_VERSION =
        createResource("http://www.w3.org/2002/07/owl#priorVersion");
    private static final Resource RDFS_SEE_ALSO =
        createResource("http://www.w3.org/2000/01/rdf-schema#seeAlso");
    private static final Resource RDFS_COMMENT =
        createResource("http://www.w3.org/2000/01/rdf-schema#comment");
    private static final Resource RDFS_IS_DEFINED_BY =
        createResource("http://www.w3.org/2000/01/rdf-schema#isDefinedBy");
    private static final Resource RDFS_LABEL =
        createResource("http://www.w3.org/2000/01/rdf-schema#label");
    ...
    private void klugeMistakes(Model m) {
        ...
        Resource OWL_DEPRECATED =
            createResource("http://www.w3.org/2002/07/owl#DeprecatedProperty");
        ...
        Resource CORE_YMDT_PRECISION =
            createResource("http://vivoweb.org/ontology/core#yearMonthDayTimePrecision");
        Resource CORE_YMD_PRECISION =
            createResource("http://vivoweb.org/ontology/core#yearMonthDayPrecision");
        Resource CORE_YM_PRECISION =
            createResource("http://vivoweb.org/ontology/core#yearMonthPrecision");
        Resource CORE_Y_PRECISION =
            createResource("http://vivoweb.org/ontology/core#yearPrecision");
        ...
        Resource CORE_CONTACT_INFO =
            createResource("http://vivoweb.org/ontology/core#contactInformation");
        ...
        Resource CORE_HAS_FUNDING =
            createResource("http://vivoweb.org/ontology/core#hasFundingVehicle");
        m.add(CORE_HAS_FUNDING, RDFS_TYPE, OWL_OBJECT_PROPERTY);

        Resource CORE_HAS_GOV_AUTH =
            createResource("http://vivoweb.org/ontology/core#hasGoverningAuthority");
