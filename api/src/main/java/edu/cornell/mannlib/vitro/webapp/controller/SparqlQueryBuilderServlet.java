...
public class SparqlQueryBuilderServlet extends BaseEditController {
    ...
    protected static HashMap<String, ResultsFormat> formatSymbols =
        new HashMap<String, ResultsFormat>();
    ...
    private void doHelp(HttpServletRequest req, HttpServletResponse res)
        throws ServletException, IOException {
