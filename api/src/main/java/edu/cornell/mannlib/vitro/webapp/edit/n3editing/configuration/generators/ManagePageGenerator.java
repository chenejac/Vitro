 ...
 */
public class ManagePageGenerator extends BaseEditConfigurationGenerator
    ...
    final static String isSelfContainedTemplateN3 =
        "?page display:isSelfContainedTemplate ?isSelfContainedTemplate .";
    ...
    private void setUrisAndLiteralsOnForm(EditConfigurationVTwo conf,
                                          VitroRequest vreq) {
        conf.setUrisOnForm(new String[] {"page", "menuItem",
            "action"}); //new resources: should this be on form for new - should be for existing
        conf.setLiteralsOnForm(
            new String[] {"pageName", "prettyUrl", "menuPosition", "menuLinkText", "customTemplate",
                "isSelfContainedTemplate",
                "pageContentUnit"}); //page content unit = data getter JSON object
    ...
    private void setFields(EditConfigurationVTwo conf) {
        ...
        FieldVTwo urlField =
            new FieldVTwo().setName("prettyUrl").setValidators(Arrays.asList("nonempty"));
        ...
        FieldVTwo menuItemPositionField =
            new FieldVTwo().setName("menuPosition").setRangeDatatypeUri(XSD.integer.getURI());
    ...
    //overriding
    @Override
    void initPropertyParameters(VitroRequest vreq, HttpSession session,
    ...
    private void addJSONArrayToFormSpecificData(ArrayNode jsonArray,
                                                EditConfigurationVTwo editConfig) {
    ...
    private void processExistingDataGetter(int counter, String dataGetterURI, String dgClassName,
                                           EditConfigurationVTwo editConfig, OntModel queryModel,
                                           ArrayNode jsonArray, ServletContext context) {
        ProcessDataGetterN3 pn =
            ProcessDataGetterN3Utils.getDataGetterProcessorN3(dgClassName, null);
    ...
    private void addDataGetterSpecificFormData(String dataGetterURI, ProcessDataGetterN3 pn,
                                               OntModel queryModel, ArrayNode jsonArray,
                                               ServletContext context) {
    ...
    private void addExistingN3Optional(EditConfigurationVTwo editConfig, ProcessDataGetterN3 pn,
                                       int counter) {
    ...
    private void addExistingLiteralsAndUrisOnForm(EditConfigurationVTwo editConfig,
                                                  ProcessDataGetterN3 pn,
                                                  int counter) {
    ...
    private void addExistingFields(EditConfigurationVTwo editConfig, ProcessDataGetterN3 pn,
                                   int counter) {
    ...
    private void addExistingDataGetterNewResources(EditConfigurationVTwo editConfig,
                                                   ProcessDataGetterN3 pn,
                                                   int counter) {
    ...
    private void addValuesInScope(EditConfigurationVTwo editConfig,
                                  ProcessDataGetterN3 pn, int counter, String dataGetterURI,
                                  OntModel queryModel) {
    ...
    private String getExistingMenuItemQuery() {
        String query =
            getSparqlPrefix() + "SELECT ?menuItem WHERE {?menuItem display:toPage ?page .}";
        return query;
    }

    private String getExistingActionQuery() {
        String query =
            getSparqlPrefix() + "SELECT ?action WHERE {?page display:requiresAction ?action .}";
        return query;
    }
    ...
    private String getExistingCustomTemplateQuery() {
        String query = getSparqlPrefix() +
            "SELECT ?customTemplate WHERE {?page display:requiresBodyTemplate ?customTemplate .}";
        return query;
    }

    private String getExistingIsSelfContainedTemplateQuery() {
        String query = getSparqlPrefix() +
            "SELECT ?isSelfContainedTemplate WHERE {?page display:isSelfContainedTemplate ?isSelfContainedTemplate .}";
    ...
    private void addRequiredPageData(VitroRequest vreq, Map<String, Object> data) {
        MenuManagementDataUtils
            .includeRequiredSystemData(vreq.getSession().getServletContext(), data);
    ...
    private HashMap<String, String> getAvailablePermissions(VitroRequest vreq) {
        ...
        availablePermissions.put(actionNamespace + "PageViewableAdmin",
            I18n.text(vreq, "page_admin_permission_option"));
        availablePermissions.put(actionNamespace + "PageViewableCurator",
            I18n.text(vreq, "page_curator_permission_option"));
        availablePermissions.put(actionNamespace + "PageViewableEditor",
            I18n.text(vreq, "page_editor_permission_option"));
        availablePermissions.put(actionNamespace + "PageViewableLoggedIn",
            I18n.text(vreq, "page_loggedin_permission_option"));
        availablePermissions.put(actionNamespace + "PageViewablePublic",
            I18n.text(vreq, "page_public_permission_option"));
    ...
    public void retrieveMenuPosition(EditConfigurationVTwo editConfig, VitroRequest vreq,
    ...
    private List<HashMap<String, String>> getAllVClasses(VitroRequest vreq) {
        ...
        ArrayList<HashMap<String, String>> classes =
            new ArrayList<HashMap<String, String>>(vclasses.size());
