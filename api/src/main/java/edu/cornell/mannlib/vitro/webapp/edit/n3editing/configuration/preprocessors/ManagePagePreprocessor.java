...
public class ManagePagePreprocessor extends
    ...
    private static List<ObjectNode> pageContentUnitsJSON = null;
//converted to JSON objects that can be read
    // String datatype
    ...
    private void copySubmissionValues() {
        ...
        transformedLiteralsFromForm =
            copyMap(EditConfigurationUtils.transformLiteralMap(literalsFromForm));
    ...
    private void processExistingValues() {
        ...
        if (this.editConfiguration.isParamUpdate()) {
            Map<String, List<Literal>> literalsInScope =
                this.editConfiguration.getLiteralsInScope();
    ...
    private void processDataGetters() {
        ...
        for (ObjectNode jsonObject : pageContentUnitsJSON) {
            ...
            ProcessDataGetterN3 pn =
                ProcessDataGetterN3Utils.getDataGetterProcessorN3(dataGetterClass, jsonObject);
        ...
        for (FieldVTwo newField : fields) {
            ...
            if (existingFields.containsKey(newFieldName)) {
                ...
                if (existingField.isEqualTo(newField)) {
                    ...
                    log.error(
                        "The field with the same name is different and will not be added as a different field exists which is different:" +
                            newFieldName);
                }
            } else {
