...
public class GetClazzAllProperties extends BaseEditController {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Object key1 : keys) {
            ...
            respo.append("<option>" + "<key>").append(key).append("</key>").append("<value>")
                .append(value.substring(0, value.length() - 1)).append("</value>").append("<type>")
                .append(value.charAt(value.length() - 1)).append("</type>").append("</option>");
        }
        respo.append("</options>");
