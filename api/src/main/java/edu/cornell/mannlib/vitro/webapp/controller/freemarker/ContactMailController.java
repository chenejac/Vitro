...
public class ContactMailController extends FreemarkerHttpServlet {
    ...
    protected ResponseValues processRequest(VitroRequest vreq) {
        ...
        String errorMsg =
            validateInput(webusername, webuseremail, comments, captchaInput, captchaDisplay);
    ...
    private ResponseValues processValidRequest(VitroRequest vreq,
                                               String webusername, String webuseremail,
                                               String[] recipients,
...
//            msg.setFrom( new InternetAddress( webuseremail ) );
    ...
    private ResponseValues errorParametersNotValid(String errorMsg, String webusername,
                                                   String webuseremail, String comments) {
        Map<String, Object> body = new HashMap<String, Object>();
