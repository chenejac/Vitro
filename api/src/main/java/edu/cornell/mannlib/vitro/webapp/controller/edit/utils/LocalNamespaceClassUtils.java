...
public class LocalNamespaceClassUtils {
    ...
    public static HashMap<String, String> getLocalNamespacesClasses(VitroRequest vreq,
        ...
        for (VClass v : allClasses) {
            ...
            if (namespaces.containsKey(classNamespace)) {
                ...
                String prefix = namespaceLabel
                    .substring(namespaceLabel.indexOf("(") + 1, namespaceLabel.indexOf(")"));
    ...
    public static String getDefaultOntologyNamespace(VitroRequest vreq) {
        ...
        if (lastIndex != -1) {
            ...
            log.error("Default namespace " + defaultNamespace +
                " should have /individual, returning null for default namespace");
            return null;
        }
    }
}
