...
public class EditRequestAJAXController extends VitroHttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            EditConfigurationAJAXGenerator generator =
                getAJAXGenerator(javaGeneratorName, vreq, vreq.getSession());
    ...
    protected EditConfigurationVTwo getEditConfiguration(VitroRequest vreq) {
        ...
        EditConfigurationVTwo config =
            EditConfigurationVTwo.getConfigFromSession(vreq.getSession(), vreq);
        return config;
    }
