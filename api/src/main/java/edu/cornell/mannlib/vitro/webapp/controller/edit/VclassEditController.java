...
public class VclassEditController extends BaseEditController {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse response) {
        ...
        for (String s : request.getUnfilteredWebappDaoFactory()
            .getCommentsForResource(vcl.getURI())) {
            if (commSb == null) {
        ...
        String hiddenFromDisplay =
            (vcl.getHiddenFromDisplayBelowRoleLevel() == null ? "(unspecified)"
        ...
        String hiddenFromPublish =
            (vcl.getHiddenFromPublishBelowRoleLevel() == null ? "(unspecified)"
                : vcl.getHiddenFromPublishBelowRoleLevel().getDisplayLabel());

        String customEntryForm =
            (vcl.getCustomEntryForm() == null ? "(unspecified)" : vcl.getCustomEntryForm());
        ...
        HashMap formSelect =
            new HashMap(); // tells the JSP what select lists are populated, and thus should be displayed
        ...
        try {
            JSPPageHandler
                .renderBasicPage(request, response, "/templates/edit/specific/classes_edit.jsp");
        } catch (Exception e) {
