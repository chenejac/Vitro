...
public class TranslationConverter {
    ...
    private void cleanTdbModel(OntModel storedModel, RDFService rdfService) {
        ...
        cs.addRemoval(removeIS, RDFServiceUtils.getSerializationFormatFromJenaString("N3"),
            ModelNames.INTERFACE_I18N);
        try {
    ...
    private void updateTDBModel(RDFService rdfService) {
        ...
        cs.addAddition(addIS, RDFServiceUtils.getSerializationFormatFromJenaString("N3"),
            ModelNames.INTERFACE_I18N);
        try {
            rdfService.changeSetUpdate(cs);
        } catch (RDFServiceException e) {
    ...
    public void convertAll() {
        List<String> i18nDirs =
            new LinkedList<>(Arrays.asList(APP_I18N_PATH, LOCAL_I18N_PATH, THEMES_PATH));
        ...
        for (String dir : i18nDirs) {
            ...
            Collection<File> files = FileUtils
                .listFiles(realDir, new RegexFileFilter(prefixesRegex + ".*\\.properties"),
    ...
    private void convert(File file) {
        ...
        for (Object key : props.keySet()) {
            ...
            QueryExecution queryExecution =
                getQueryExecution(key.toString(), theme, application, langTag);
            ...
            String addition =
                fillOutTemplate(uri, key.toString(), value.toString(), theme, application, langTag);
    ...
    private String fillOutTemplate(String uri, String key, String newLabel, String theme,
                                   String application, String langTag) {
    ...
    private String fillOutFullTemplate(String key, String label, String theme, String application,
                                       String langTag) {
    ...
    private QueryExecution getQueryExecution(String key, String theme, String application,
                                             String langTag) {
        Query query;
