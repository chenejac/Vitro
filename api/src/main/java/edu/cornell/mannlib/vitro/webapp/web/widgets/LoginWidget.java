...
public class LoginWidget extends Widget {
    ...
    private WidgetTemplateValues showPasswordChangeScreen(HttpServletRequest request) {
        ...
        values.put(TemplateVariable.MINIMUM_PASSWORD_LENGTH.toString(),
            UserAccount.MIN_PASSWORD_LENGTH);
        values.put(TemplateVariable.MAXIMUM_PASSWORD_LENGTH.toString(),
            UserAccount.MAX_PASSWORD_LENGTH);
