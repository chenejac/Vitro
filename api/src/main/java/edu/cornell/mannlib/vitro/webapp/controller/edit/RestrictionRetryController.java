    ...
    public void doGet(HttpServletRequest req, HttpServletResponse response) {
        ...
        try {
            ...
            boolean propertyType =
                ("data".equals(request.getParameter("propertyType"))) ? DATA : OBJECT;
            ...
            switch (restrictionTypeStr) {
                case "someValuesFrom": {
                    request.setAttribute("specificRestrictionForm",
                        "someValuesFromRestriction_retry.jsp");
                ...
                case "allValuesFrom": {
                    request.setAttribute("specificRestrictionForm",
                        "allValuesFromRestriction_retry.jsp");
                    List<Option> optionList = (propertyType == OBJECT)
                        ? getValueClassOptionList(request)
                        : getValueDatatypeOptionList(request);
                    epo.getFormObject().getOptionLists().put("ValueClass", optionList);
                ...
                case "hasValue":
                    request
                        .setAttribute("specificRestrictionForm", "hasValueRestriction_retry.jsp");
                ...
                case "cardinality":
                    request.setAttribute("specificRestrictionForm",
                        "cardinalityRestriction_retry.jsp");
                    break;
            }
            ...
            try {
                ...
                log.error(this.getClass().getName() +
                    "PropertyRetryController could not forward to view.");
