...
public class DataPropertyDaoFiltering extends BaseFiltering implements DataPropertyDao {
    ...
    public Collection<DataProperty> getAllPossibleDatapropsForIndividual(String individualURI) {
        ...
        for (DataProperty dp : innerDataPropertyDao
            .getAllPossibleDatapropsForIndividual(individualURI)) {
            DataPropertyStatementImpl dps =
                new DataPropertyStatementImpl(individualURI, dp.getURI(), SOME_LITERAL);
