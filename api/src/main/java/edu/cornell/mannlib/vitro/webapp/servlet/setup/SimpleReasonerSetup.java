...
public class SimpleReasonerSetup implements ServletContextListener {
    ...
    public static final String JENA_INF_MODEL_REBUILD =
        "http://vitro.mannlib.cornell.edu/default/vitro-kb-inf-rebuild";
    public static final String JENA_INF_MODEL_SCRATCHPAD =
    ...
    public static SimpleReasonerTBoxListener getSimpleReasonerTBoxListenerFromContext(
        ServletContext ctx) {
        Object simpleReasonerTBoxListener =
            ctx.getAttribute(SimpleReasonerTBoxListener.class.getName());
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            OntModel tboxAssertionsModel =
                ModelAccess.on(ctx).getOntModel(ModelNames.TBOX_ASSERTIONS);
            OntModel tboxInferencesModel =
                ModelAccess.on(ctx).getOntModel(ModelNames.TBOX_INFERENCES);
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        ...
        SimpleReasoner simpleReasoner =
            getSimpleReasonerFromServletContext(sce.getServletContext());
        ...
        SimpleReasonerTBoxListener simpleReasonerTBoxListener =
            getSimpleReasonerTBoxListenerFromContext(sce.getServletContext());
