...
public class JFactTBoxReasoner implements
	...
	*/
    ...
    private void clearEmptyAxiomStatements() {
        ...
        StmtIterator axiomStatements = filteredAssertionsModel
            .listStatements(null, RDF.type, ResourceFactory.createResource(OWL_AXIOM.toString()));
        ...
        if (removeStatements.size() > 0) {
            log.warn("The following statements are empty axiom statements and have been removed" +
                removeStatements.toString());
