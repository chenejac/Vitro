...
public class PolicyDecisionLogger {
    ...
    private boolean passesUserRestriction() {
        Pattern userRestriction =
            compilePatternFromSetting(Key.AUTHORIZATION_LOG_DECISIONS_USER_RESTRICTION);
    ...
    private boolean passesActionRestriction() {
        Pattern actionRestriction =
            compilePatternFromSetting(Key.AUTHORIZATION_LOG_DECISIONS_ACTION_RESTRICTION);
