...
public interface ImageProcessor extends Application.Module {
     ...
     *
     * @param image The image stream. This method will not close it.
     * @return The dimensions of the image. Never returns null.
     * @throws ImageProcessorException if the stream does not contain a valid image.
     ...
     *
     * @param image  The image stream. This method will not close it.
     * @param crop   x and y determine the upper left corner of the crop area.
     *               height and width determine the size of the crop area.
     * @param limits The resulting image will be reduced as necessary to fit within
     *               these dimensions.
     * @return The new image. Client code should close this stream after
     * reading. Never returns null.
     * @throws ImageProcessorException If the image is smaller than the minimum crop size, or if
     *                                 there is another problem cropping the image.
     * @throws IOException             if the image stream cannot be read.
     */
