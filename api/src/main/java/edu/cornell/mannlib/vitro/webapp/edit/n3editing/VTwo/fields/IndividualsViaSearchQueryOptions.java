 ...
 */
public class IndividualsViaSearchQueryOptions extends IndividualsViaVClassOptions
    ...
    public IndividualsViaSearchQueryOptions(String inputSubjectUri, String inputPredicateUri,
                                            String inputObjectUri, String... vclassURIs)
        throws Exception {
        super(vclassURIs);
