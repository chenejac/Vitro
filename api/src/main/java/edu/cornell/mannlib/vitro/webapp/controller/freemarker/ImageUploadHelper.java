...
public class ImageUploadHelper {
    ...
    private static final String ERROR_CODE_UNRECOGNIZED_FILE_TYPE =
        "imageUpload.errorUnrecognizedFileType";
    private static final String ERROR_CODE_NO_PHOTO_SELECTED = "imageUpload.errorNoPhotoSelected";
    private static final String ERROR_CODE_BAD_MULTIPART_REQUEST =
        "imageUpload.errorBadMultipartRequest";
     ...
     */
    private static final Map<String, String> NON_STANDARD_MIME_TYPES =
        createNonStandardMimeTypesMap();
     ...
     * empty file.
     *
     * @throws UserMistakeException if there is no file, if it is empty, or if it is not an image
     *                              file.
     */
     ...
     *
     * @throws UserMistakeException if the image is smaller than a thumbnail.
     */
     ...
     *
     * @throws UserMistakeException if it isn't there.
     */
