        ...
        try {
            ...
            if (!FreemarkerEmailFactory.isConfigured(request)) {
                ...
                JSPPageHandler.renderBasicPage(request, response,
                    "/contact_err.jsp");// <<< this is where the body gets set
            }
            ...
            if (request.getHeader("Referer") == null) {
                ...
                request.getSession()
                    .setAttribute("commentsFormReferer", request.getHeader("Referer"));
            }

            request.setAttribute("title", appBean.getApplicationName() + " Mail Users Form");
            JSPPageHandler.renderBasicPage(request, response,
                "/templates/parts/emailUsers.jsp");// <<< this is where the body gets set
        } catch (Throwable e) {
