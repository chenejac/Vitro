...
public class ObjectPropertyDaoFiltering extends BaseFiltering implements ObjectPropertyDao {
    ...
    public static List<ObjectProperty> filterAndWrap(List<ObjectProperty> list,
                                                     VitroFilters filters) {
        if (list == null) {
            return null;
        }
    ...
    public List getObjectPropertiesForObjectPropertyStatements(
    ...
    public ObjectProperty getObjectPropertyByURIs(String objectPropertyURI, String domainURI,
                                                  String rangeURI) {
        ObjectProperty newOprop =
            innerObjectPropertyDao.getObjectPropertyByURIs(objectPropertyURI, domainURI, rangeURI);
        return (newOprop == null) ? null : new ObjectPropertyFiltering(newOprop, filters);
    }

    public ObjectProperty getObjectPropertyByURIs(String objectPropertyURI, String domainURI,
                                                  String rangeURI, ObjectProperty base) {
        ObjectProperty newOprop = innerObjectPropertyDao
            .getObjectPropertyByURIs(objectPropertyURI, domainURI, rangeURI, base);
        return (newOprop == null) ? null : new ObjectPropertyFiltering(newOprop, filters);
    }
