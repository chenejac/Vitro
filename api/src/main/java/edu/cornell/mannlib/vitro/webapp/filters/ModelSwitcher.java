...
public class ModelSwitcher {
    ...
    public static boolean authorizedForSpecialModel(HttpServletRequest req) {
        if (isParameterPresent(req, SWITCH_TO_DISPLAY_MODEL)) {
            ...
            return PolicyHelper
                .isAuthorizedForActions(req, SimplePermission.ACCESS_SPECIAL_DATA_MODELS.ACTION);
        } else {
            return true;
        }
    }
    ...
    public WebappDaoFactory checkForModelSwitching(VitroRequest vreq, WebappDaoFactory inputWadf) {
        ...
        if (isParameterPresent(vreq, SWITCH_TO_DISPLAY_MODEL)) {
            ...
            vreq.setAttribute(VitroRequest.ID_FOR_ABOX_MODEL,
                VitroModelSource.ModelName.DISPLAY.toString());
            vreq.setAttribute(VitroRequest.ID_FOR_TBOX_MODEL,
                VitroModelSource.ModelName.DISPLAY_TBOX.toString());
            vreq.setAttribute(VitroRequest.ID_FOR_DISPLAY_MODEL,
                VitroModelSource.ModelName.DISPLAY_DISPLAY.toString());
            vreq.setAttribute(VitroRequest.ID_FOR_WRITE_MODEL,
                VitroModelSource.ModelName.DISPLAY.toString());
        ...
        if (anyOtherSpecialProperties(vreq)) {
            ...
            vreq.setAttribute(VitroRequest.ID_FOR_TBOX_MODEL,
                vreq.getParameter(USE_TBOX_MODEL_PARAM));
            vreq.setAttribute(VitroRequest.ID_FOR_DISPLAY_MODEL,
                vreq.getParameter(USE_DISPLAY_MODEL_PARAM));
