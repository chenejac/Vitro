    ...
    public static String StemString(String inputStr, int maxLength) {
        ...
        for (inputArrayIndex = 0; inputArrayIndex < inputArray.length; inputArrayIndex++) {
            ...
            if (Character.isLetter((char) ch)) {
                ...
                while (inputArrayIndex <
                    inputArray.length) { // keep reading until hit character other than a letter
                    ...
                    if (inputArrayIndex < inputArray.length - 1) {
                        ...
                        if (!Character.isLetter(
                            (char) ch)) { // parse the word in preparation for starting a new one
                            for (int c = 0; c < stemmerInputBufferIndex;
                                 c++) { // copy to stemmer internal buffer
                                s.add(w[c]);
                            }
                            s.stem();
                            {
                ...
                while (ch != ')') {
                    if (inputArrayIndex < inputArray.length) {
                        ...
                        log.trace("");
                        log.trace("1 short of EOS in paren at pos: " + inputArrayIndex + " of " +
                            inputStr);
                        break;
                    }
                    Character Ch = new Character((char) ch);
                ...
                */
                ...
                outputStr.append(Ch.toString());
                log.trace(Ch.toString());
                log.trace("found close paren at position: " + inputArrayIndex + " of input term " +
                    inputStr);
