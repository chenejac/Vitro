...
public class PageController extends FreemarkerHttpServlet {
    ...
    protected ResponseValues processRequest(VitroRequest vreq) throws Exception {
        ...
        mapForTemplate
            .putAll(getPageControllerValues(pageUri, vreq, getServletContext(), mapForTemplate));
...
*/
    ...
    private void executeDataGetters(String pageUri, VitroRequest vreq,
                                    Map<String, Object> mapForTemplate)
        throws Exception {
        List<DataGetter> dgList =
            DataGetterUtils.getDataGettersForPage(vreq, vreq.getDisplayModel(), pageUri);
    ...
    private Map<String, Object> getPageControllerValues(
        ...
        if (PolicyHelper.isAuthorizedForActions(vreq, SimplePermission.MANAGE_MENUS.ACTION)) {
            ...
            editPageUrl =
                UrlBuilder.addParams(editPageUrl, DisplayVocabulary.SWITCH_TO_DISPLAY_MODEL, "1");
