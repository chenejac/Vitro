...
public interface FauxPropertyDao {
     ...
     *
     * @param domainUri May be null, but then this will only match a ConfigContext
     *                  that has no qualifiedByDomain property.
     * @param baseUri   Object of configContextFor property. May not be null.
     * @param rangeUri  Object of qualifiedBy property. May not be null.
     * @return May return null.
     */
     ...
     *
     * @throws IllegalStateException    if fp does not have null values for contextUri and configUri,
     *                                  or if a FauxProperty already exists with this combination of
     *                                  domain, base, and range URIs.
     * @throws IllegalArgumentException if fp is not internally consistent.
     */
     ...
     *
     * @throws IllegalStateException    if the display model contains no such individuals. If you
