    ...
    protected ResponseValues processRequest(VitroRequest vreq) {
        ...
        if (classes != null) {
            ...
            for (VClass aClass : classes) {
                ...
                VClass cls = aClass;
                if ((ontologyURI == null) ||
                    ((ontologyURI != null) && (cls.getNamespace() != null) &&
                        (ontologyURI.equals(cls.getNamespace())))) {
                    if (cls.getName() != null) {
                        try {
                            json.append("{ \"name\": ").append(JacksonUtils.quote(
                                "<a href='./vclassEdit?uri=" +
                                    URLEncoder.encode(cls.getURI(), "UTF-8") + "'>" +
                                    cls.getPickListName() + "</a>")).append(", ");
                        } catch (Exception e) {
                            json.append("{ \"name\": ")
                                .append(JacksonUtils.quote(cls.getPickListName())).append(", ");
                        }
                    } else {
                        json.append("{ \"name\": \"\"");
                    }
                    ...
                    json.append("\"data\": { \"shortDef\": ").append(JacksonUtils.quote(shortDef))
                        .append(", ");
                    ...
                    json.append("\"classGroup\": ").append(JacksonUtils.quote(groupName))
                        .append(", ");
