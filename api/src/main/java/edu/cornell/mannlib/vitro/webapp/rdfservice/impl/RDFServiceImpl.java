...
public abstract class RDFServiceImpl implements RDFService {
    ...
    protected List<ModelChangedListener> registeredJenaListeners =
        new CopyOnWriteArrayList<ModelChangedListener>();
    /*
    ...
    protected static String getSerializationFormatString(
