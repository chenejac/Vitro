...
public class JsonServlet extends VitroHttpServlet {
    ...
    public static ObjectNode getSearchIndividualsByVClass(String vclassURI, HttpServletRequest req)
        throws Exception {
    ...
    public static ObjectNode getSearchIndividualsByVClasses(List<String> vclassURIs,
        ...
        IndividualListResults vcResults = getSearchVClassIntersectionResults(vclassURIs, vreq);
        log.debug(
            "Results returned from search engine for " + vclassURIs.toString() + " are of size " +
    ...
    private static IndividualListResults getSearchVClassIntersectionResults(List<String> vclassURIs,
        ...
        try {
            ...
            log.error("Error in retrieval of search results for VClass " + vclassURIs.toString(),
                ex);
            return IndividualListResults.EMPTY;
        }
    }

    public static String getDataPropertyValue(Individual ind, DataProperty dp,
    ...
    public static ObjectNode getRandomSearchIndividualsByVClass(String vclassURI,
                                                                HttpServletRequest req)
        throws Exception {
        VitroRequest vreq = new VitroRequest(req);
    ...
    private static IndividualListResults getRandomSearchVClassResults(String vclassURI,
                                                                      VitroRequest vreq) {
