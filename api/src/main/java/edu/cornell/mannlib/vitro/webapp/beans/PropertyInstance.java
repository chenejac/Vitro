...
public class PropertyInstance implements PropertyInstanceIface, Comparable<PropertyInstance> {
     ...
     */
    public void setPropertyURI(String in) {
        propertyURI = in;
    }
     ...
     */
    public void setObjectName(String in) {
        objectName = in;
    }
     ...
     */
    public void setDomainClassURI(String in) {
        domainClassURI = in;
    }
     ...
     */
    public void setDomainClassName(String in) {
        domainClassName = in;
    }
     ...
     */
    public void setRangeClassName(String in) {
        rangeClassName = in;
    }
     ...
     */
    public void setObjectEntURI(String in) {
        objectEntURI = in;
    }
     ...
     */
    public String getSubjectEntURI() {
        return subjectEntURI;
    }

    /* (non-Javadoc)
     * @see edu.cornell.mannlib.vitro.beans.PropertyInstanceIface#setDomainEntId(int)
     */
    public void setSubjectEntURI(String in) {
        subjectEntURI = in;
    }
     ...
     */
    public void setDomainPublic(String in) {
        domainPublic = in;
    }
     ...
     */
    public void setRangePublic(String in) {
        rangePublic = in;
    }
     ...
     */
    public void setSubjectSide(boolean in) {
        subjectSide = in;
    }
     ...
     */
    public void setDomainQuickEditJsp(String in) {
        domainQuickEditJsp = in;
    }
     ...
     */
    public void setRangeQuickEditJsp(String in) {
        rangeQuickEditJsp = in;
    }
