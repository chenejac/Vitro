...
public interface UserAccountsDao {
     ...
     *
     * @throws NullPointerException     if the UserAccount is null.
     * @throws IllegalArgumentException if the URI of the UserAccount is not empty.
     */
     ...
     *
     * @throws NullPointerException     if the UserAccount is null.
     * @throws IllegalArgumentException if a UserAccount with this URI does not already exist in the
     *                                  model.
     */
