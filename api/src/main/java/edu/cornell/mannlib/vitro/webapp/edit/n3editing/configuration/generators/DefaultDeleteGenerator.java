 ...
 */
public class DefaultDeleteGenerator extends BaseEditConfigurationGenerator
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq,
        ...
        if (editConfiguration.getPredicateUri() == null &&
            editConfiguration.getSubjectUri() == null) {
    ...
    private void processDataPropForm(VitroRequest vreq, HttpSession session,
                                     EditConfigurationVTwo editConfiguration) {
        ...
        if (dataHash != null) {
            ...
            dps = EditConfigurationUtils
                .getDataPropertyStatement(vreq, session, dataHash, predicateUri);
            if (dps != null) {
