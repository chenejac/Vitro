...
public class ProcessClassGroupDataGetterN3 extends ProcessDataGetterAbstract {
    ...
    public List<String> retrieveN3ForTypeAndClassGroup(int counter) {
        ...
        String n3 = n3ForType + "; \n" +
            ...
            getN3VarName(classGroupVarBase, counter) + " .";
    ...
    private void getExistingClassGroup(String dataGetterURI, ObjectNode jObject,
                                       OntModel queryModel) {
        String querystr = getExistingValuesClassGroup(dataGetterURI);
        QueryExecution qe = null;
        try {
    ...
    protected void getExistingClassesInClassGroup(ServletContext context, String dataGetterURI,
                                                  ObjectNode jObject) {
