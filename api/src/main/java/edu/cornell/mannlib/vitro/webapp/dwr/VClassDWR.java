...
public class VClassDWR {
     ...
     */
    public Collection<VClass> getVClasses(String vclassURI, String propertyURI,
        ...
        vclasses = vreq.getWebappDaoFactory().getVClassDao()
            .getVClassesForProperty(vclassURI, propertyURI);
