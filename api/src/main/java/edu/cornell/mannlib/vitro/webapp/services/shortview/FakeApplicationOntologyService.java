...
public class FakeApplicationOntologyService {
    ...
    private static final String PEOPLE_CLASSGROUP_URI =
    ...
    private List<String> getDataPropertyValues(Resource subject,
                                               Property predicate, String label)
        throws ShortViewConfigException {
    ...
    public TemplateAndDataGetters getShortViewProperties(VitroRequest vreq,
                                                         Individual individual, String classUri,
                                                         String contextName) {
        /*
    ...
    private static class FakeVivoPeopleDataGetter extends SparqlQueryDataGetter {
        ...
        private static final String FAKE_VIVO_PEOPLE_DATA_GETTER_URI =
            "http://FakeVivoPeopleDataGetter";
        /*
        ...
        public FakeVivoPeopleDataGetter(VitroRequest vreq, String individualUri) {
            ...
            this.langCtx =
                vreq.getLocale().getLanguage(); // UQAM-Optimization add the linguistic context
        ...
        private static OntModel initializeFakeDisplayModel() {
            ...
            m.add(dataGetter, queryProperty,
                QUERY_STRING_LANG); //UQAM-Optimization Using query with linguistic context
