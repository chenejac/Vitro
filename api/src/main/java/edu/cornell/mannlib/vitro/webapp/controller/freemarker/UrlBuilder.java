...
public class UrlBuilder {
    ...
    public static String urlEncode(String str) {
        ...
        try {
            ...
            log.error("Error encoding url " + str + " with encoding " + encoding +
    ...
    public static String urlDecode(String str) {
        ...
        try {
            ...
            log.error("Error decoding url " + str + " with encoding " + encoding +
                ": Unsupported encoding.");
        }
        return decodedUrl;
    }
    ...
    public static LinkedHashMap<String, String> getModelParams(VitroRequest vreq) {
        ...
        if (vreq != null) {
            ...
            String useDisplayModelUri =
                vreq.getParameter(DisplayVocabulary.USE_DISPLAY_MODEL_PARAM);
            if (useMenuModelParam != null && !useMenuModelParam.isEmpty()) {
                ...
                if (useDisplayModelUri != null && !useDisplayModelUri.isEmpty()) {
                    specialParams
                        .put(DisplayVocabulary.USE_DISPLAY_MODEL_PARAM, useDisplayModelUri);
                }
            }
        }
