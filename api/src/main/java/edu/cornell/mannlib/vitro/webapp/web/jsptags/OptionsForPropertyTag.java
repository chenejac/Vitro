...
public class OptionsForPropertyTag extends TagSupport {
    ...
    public int doStartTag() {
        try {
            ...
            ObjectProperty objProp =
                wdf.getObjectPropertyDao().getObjectPropertyByURI(getPredicateUri());
            if (objProp == null) {
                throw new Exception(
                    "could not get object property for predicate " + getPredicateUri());
            }
            ...
            for (VClass vclass : vclasses) {
                for (Individual ind : wdf.getIndividualDao()
                    .getIndividualsByVClassURI(vclass.getURI(), -1, -1)) {
            ...
            for (Individual ind : individuals) {
                ...
                if (uri != null) {
                    out.print(
                        "<option value=\"" + StringEscapeUtils.ESCAPE_HTML4.translate(uri) + '"');
            ...
            log.trace(
                "added " + optionsCount + " options for object property \"" + getPredicateUri() +
    ...
    private class compareEnts implements Comparator<Individual> {
        public int compare(Individual o1, Individual o2) {
            return ((o1.getName() == null) ? "" : o1.getName())
                .compareToIgnoreCase((o2.getName() == null) ? "" : o2.getName());
        }
    }
}
