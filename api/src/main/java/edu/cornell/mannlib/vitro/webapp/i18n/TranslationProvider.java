...
public class TranslationProvider {
    ...
    private static String formatString(String textString, Object... parameters) {
        if (parameters.length == 0) {
            ...
            return MessageFormat
                .format(TranslationProvider.preprocessForFormating(textString), parameters);
        }
    }
    ...
    public void initialize(ServletContext ctx) {
        RevisionInfoBean info =
            (RevisionInfoBean) ctx.getAttribute(RevisionInfoBean.ATTRIBUTE_NAME);
    ...
    private String prepareExportInfo(String key, Object[] parameters, String text, String message) {
        ...
        return I18nBundle.START_SEP + key + I18nBundle.INT_SEP + text + I18nBundle.INT_SEP +
            separatedArgs
    ...
    private String getText(List<String> preferredLocales, String key) {
        ...
        LanguageFilteringRDFService lfrs =
            new LanguageFilteringRDFService(rdfService, preferredLocales);
