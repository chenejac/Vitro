...
public class EditRequestDispatchController extends FreemarkerHttpServlet {
    ...
    final String DEFAULT_OBJ_FORM =
        "edu.cornell.mannlib.vitro.webapp.edit.n3editing.configuration.generators.DefaultObjectPropertyFormGenerator";
    final String DEFAULT_DATA_FORM =
        "edu.cornell.mannlib.vitro.webapp.edit.n3editing.configuration.generators.DefaultDataPropertyFormGenerator";
    ...
    final String DEFAULT_DELETE_FORM =
        "edu.cornell.mannlib.vitro.webapp.edit.n3editing.configuration.generators.DefaultDeleteGenerator";
    final String MANAGE_MENUS_FORM =
        "edu.cornell.mannlib.vitro.webapp.edit.n3editing.configuration.generators.ManagePageGenerator";
    ...
    protected AuthorizationRequest requiredActions(VitroRequest vreq) {
        ...
        if (StringUtils.isBlank(objectUri)) {
            objectPropertyAction =
                new AddObjectPropertyStatement(ontModel, subjectUri, predicateProp,
                    RequestedAction.SOME_URI);
        } else {
            if (isDeleteForm(vreq)) {
                objectPropertyAction =
                    new DropObjectPropertyStatement(ontModel, subjectUri, predicateProp, objectUri);
            } else {
                objectPropertyAction =
                    new EditObjectPropertyStatement(ontModel, subjectUri, predicateProp, objectUri);
            }
        }
        ...
        return isAuthorized ? SimplePermission.DO_FRONT_END_EDITING.ACTION :
    ...
    protected ResponseValues processRequest(VitroRequest vreq) {
        ...
        try {
            ...
            MultiValueEditSubmissionTemplateModel submissionTemplateModel =
                new MultiValueEditSubmissionTemplateModel(submission);

            //what goes in the map for templates?
            Map<String, Object> templateData = new HashMap<String, Object>();
            EditConfigurationTemplateModel etm =
                new EditConfigurationTemplateModel(editConfig, vreq);
    ...
    private MultiValueEditSubmission getMultiValueSubmission(VitroRequest vreq,
    ...
    private EditConfigurationVTwo setupEditConfiguration(String editConfGeneratorName,
        ...
        EditConfigurationVTwo existingConfig =
    ...
    private Property getProperty(String predicateUri, String domainUri, String rangeUri,
                                 VitroRequest vreq) {
        Property p = null;
        try {
            ...
            if (p == null) {
                p = vreq.getWebappDaoFactory().getDataPropertyDao()
                    .getDataPropertyByURI(predicateUri);
            }
        } catch (Throwable th) {
            //ignore problems
    ...
    private EditConfigurationVTwo makeEditConfigurationVTwo(
        ...
        if (EditConfigurationVTwoGenerator == null) {
            throw new Error(
                "Could not find EditConfigurationVTwoGenerator " + editConfGeneratorName);
        } else {
