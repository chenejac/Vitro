...
public interface SearchIndexer extends Application.Module {
     ...
     *
     * @throws IllegalStateException if called after shutdown, or if called more than once.
     */
    @Override
     ...
     *
     * @param changes if null or empty, this call has no effect.
     */
     ...
     * called after shutdown, this has no effect.
     *
     * @param uris if null or empty, this call has no effect.
     */
     ...
     *
     * @param listener if null, this method has no effect.
     */
