...
public class GetObjectClasses extends BaseEditController {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vClass != null) {
            respo.append("<option>" + "<key>").append(vClass.getPickListName()).append("</key>")
                .append("<value>").append(vClass.getURI()).append("</value>").append("</option>");
        } else {
            ...
            for (VClassGroup group : classGroups) {
                ...
                for (VClass clazz : classes) {
                    respo.append("<option>" + "<key>").append(clazz.getPickListName())
                        .append("</key>").append("<value>").append(clazz.getURI())
