...
public interface EditElementVTwo {
    ...
    getLiterals(String fieldName, EditConfigurationVTwo editConfig,
    ...
    getURIs(String fieldName, EditConfigurationVTwo editConfig,
            Map<String, String[]> queryParameters);
    ...
    getValidationMessages(String fieldName, EditConfigurationVTwo editConfig,
                          Map<String, String[]> queryParameters);
