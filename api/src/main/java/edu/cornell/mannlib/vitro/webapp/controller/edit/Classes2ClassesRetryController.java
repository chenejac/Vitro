...
public class Classes2ClassesRetryController extends BaseEditController {
    ...
    private static final Log log =
        LogFactory.getLog(Classes2ClassesRetryController.class.getName());
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse response) {
        ...
        hash.put("SuperclassURI", FormUtils
            .makeOptionListFromBeans(vcDao.getAllVclasses(), "URI", "PickListName",
                objectForEditing.getSuperclassURI(), null));
        hash.put("SubclassURI", FormUtils
            .makeOptionListFromBeans(vcDao.getAllVclasses(), "URI", "PickListName",
