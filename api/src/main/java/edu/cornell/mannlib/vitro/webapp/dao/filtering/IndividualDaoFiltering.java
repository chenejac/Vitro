...
public class IndividualDaoFiltering extends BaseFiltering implements IndividualDao {
    ...
    public List<Individual> getIndividualsByDataProperty(String dataPropertyUri, String value) {
        return filterAndWrap(
            innerIndividualDao.getIndividualsByDataProperty(dataPropertyUri, value),
            filters);
    }
    ...
    public List<Individual> getIndividualsByDataProperty(
        ...
        String lang) {
        return filterAndWrap(innerIndividualDao
                .getIndividualsByDataProperty(dataPropertyUri, value, datatypeUri, lang),
            filters);
    }
    ...
    public List getIndividualsByVClassURI(String vclassURI, int offset, int quantity) {
        List<Individual> list =
            innerIndividualDao.getIndividualsByVClassURI(vclassURI, offset, quantity);
        if (list == null) {
            return Collections.EMPTY_LIST;
        } else {
            return filterAndWrap(list, filters);
