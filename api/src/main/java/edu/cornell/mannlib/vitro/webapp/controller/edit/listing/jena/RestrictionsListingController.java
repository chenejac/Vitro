...
public class RestrictionsListingController extends BaseEditController {
    ...
    private void tryRestriction(OntClass theClass, VClassDao vcDao, ObjectPropertyDao opDao,
                                IndividualDao iDao, ArrayList results, String vClassURI) {
        if (theClass.isRestriction()) {
            ...
            try {
                ...
                if (rest.isAllValuesFromRestriction()) {
                    ...
                    HasValueRestriction hvrest =
                        (HasValueRestriction) rest.as(HasValueRestriction.class);
