...
public abstract class BaseDumpDirective implements TemplateDirectiveModel {
    ...
    private static final String TEMPLATE_DEFAULT = "dump.ftl";
        // change to dump.ftl when old dump is removed
    ...
    private Map<String, Object> getTemplateModelDump(TemplateScalarModel model)
        throws TemplateModelException {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    private Map<String, Object> getTemplateModelDump(TemplateBooleanModel model)
        throws TemplateModelException {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    private Map<String, Object> getTemplateModelDump(TemplateNumberModel model)
        throws TemplateModelException {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    private Map<String, Object> getTemplateModelDump(TemplateDateModel model)
        throws TemplateModelException {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    private Map<String, Object> getTemplateModelDump(TemplateHashModel model)
        throws TemplateModelException {
    ...
    private Map<String, Object> getTemplateModelDump(TemplateSequenceModel model)
        throws TemplateModelException {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    private Map<String, Object> getTemplateModelDump(TemplateHashModelEx model)
        throws TemplateModelException {
    ...
    private Map<String, Object> getMapDump(TemplateHashModelEx model)
        throws TemplateModelException {
        Map<String, Object> map = new HashMap<String, Object>();
                ...
                if (matcher.find()) {
                    ...
                    if (keySet.contains(propertyName)) {
                        try {
                            ...
                            log.error("problem dumping " + propertyName + " on " +
    ...
    private Map<String, Object> getTemplateModelDump(TemplateCollectionModel model)
        throws TemplateModelException {
        Map<String, Object> map = new HashMap<String, Object>();
        ...
        if (model instanceof TemplateMethodModel || model instanceof TemplateDirectiveModel) {
            ...
            try {
                ...
                try {
                    ...
                    log.error("Error invoking method help() on " + modelClass + " of class " +
                        cls.getName());
                    return null;
                }
            } catch (NoSuchMethodException e) {
                log.info(
                    "No help() method defined for " + modelClass + " of class " + cls.getName());
                return null;
            } catch (Exception e) {
    ...
    private Map<String, Object> getTemplateModelDump(TemplateModel model)
        throws TemplateModelException {
    ...
    protected Map<? extends String, ? extends Object> toMap(Object hash)
        ...
        if (hash instanceof TemplateHashModelEx) {
            ...
            log.error("Freemarker is passing odd objects to method toMap(): " +
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (obj instanceof StringModel) {
                    ...
                    log.error("Freemarker is setting keys to hashes as non-strings: " +
