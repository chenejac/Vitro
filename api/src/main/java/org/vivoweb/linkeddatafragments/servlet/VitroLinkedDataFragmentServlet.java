...
public class VitroLinkedDataFragmentServlet extends VitroHttpServlet {
    ...
    public void init(ServletConfig servletConfig) throws ServletException {
        try {
            ...
            HtmlTriplePatternFragmentWriterImpl
                .setContextPath(servletConfig.getServletContext().getContextPath());
        } catch (Exception e) {
    ...
    private String getConfigJson(OntologyDao dao) {
        ...
        configJson.append("    \"RDFServiceDatasource\": \"")
            .append(RDFServiceDataSourceType.class.getCanonicalName()).append("\"\n");
        configJson.append("  },\n");
        configJson.append("\n");
        ...
        configJson
            .append("    \"rdf\":         \"http://www.w3.org/1999/02/22-rdf-syntax-ns#\",\n");
