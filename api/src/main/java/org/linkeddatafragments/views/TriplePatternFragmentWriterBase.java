 ...
 */
public abstract class TriplePatternFragmentWriterBase extends LinkedDataFragmentWriterBase
     ...
     * @param datasources
     */
    public TriplePatternFragmentWriterBase(Map<String, String> prefixes,
    ...
    public void writeFragment(ServletOutputStream outputStream, IDataSource datasource,
        ...
        throws Exception {
        writeFragment(outputStream, datasource, (ITriplePatternFragment) fragment,
            (ITriplePatternFragmentRequest) ldfRequest);
    }
     ...
     */
    abstract public void writeFragment(ServletOutputStream outputStream, IDataSource datasource,
