...
public class TriplePatternElementFactory<CTT, NVT, AVT> {
    ...
    static public class NamedVariable<CTT, NVT, AVT>
         ...
         * @param variable
         */
        public NamedVariable(final NVT variable) {
            v = variable;
        }
        ...
        @Override
        public String toString() {
            return "NamedVariable(" + v.toString() + ")";
        }
    }
    ...
    static public class AnonymousVariable<CTT, NVT, AVT>
         ...
         * @param bnode
         */
        public AnonymousVariable(final AVT bnode) {
            bn = bnode;
        }
    ...
    static public class ConstantRDFTerm<CTT, NVT, AVT>
         ...
         * @param term
         */
        public ConstantRDFTerm(final CTT term) {
            t = term;
        }
        ...
        @Override
        public String toString() {
            return "ConstantRDFTerm(" + t.toString() + ")(type: " + t.getClass().getSimpleName() +
                ")";
        }
    }
