...
public interface IDataSourceType {
     ...
     *
     * @param title       The title of the data source (as given in the config file).
     * @param description The description of the data source (as given in the config file).
     * @param settings    The properties of the data source to be created; usually, these
