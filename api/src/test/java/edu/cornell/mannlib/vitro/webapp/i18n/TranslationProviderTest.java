...
public class TranslationProviderTest {
    ...
    public void init(String i18nFile, String themeName, String appName)
    ...
    public void testNotExistingKey() throws FileNotFoundException {
        ...
        Object array[] = {};
        String translation =
            tp.getTranslation(Collections.singletonList("en-US"), "non_existing_key", array);
    ...
    public void testVitroWilmaEnUS() throws FileNotFoundException {
        ...
        Object array[] = {};
        String translation =
            tp.getTranslation(Collections.singletonList("en-US"), "testkey", array);
    ...
    public void testVitroWilmaDeDE() throws FileNotFoundException {
        ...
        Object array[] = {};
        String translation =
            tp.getTranslation(Collections.singletonList("de-DE"), "testkey", array);
    ...
    public void testAppFallbackVIVONemoEnUS() throws FileNotFoundException {
        ...
        Object array[] = {};
        String translation =
            tp.getTranslation(Collections.singletonList("en-US"), "testkey_app_fallback", array);
    ...
    public void testAppFallbackVIVONemoDeDE() throws FileNotFoundException {
        ...
        Object array[] = {};
        String translation =
            tp.getTranslation(Collections.singletonList("de-DE"), "testkey_app_fallback", array);
