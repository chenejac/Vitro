...
public class BasicValidationVTwoTest {
    ...
    public void testHttpUrlValidate() {
        ...
        BasicValidationVTwo bv =
            new BasicValidationVTwo(Collections.EMPTY_MAP, I18nStub.bundle(req));
        String res;
        ...
        res = bv.validate("httpUrl",
            "http://example.com/index#2.23?bogus=skjd%20skljd&something=sdkf");
        Assert.assertEquals(BasicValidationVTwo.SUCCESS, res);
    }
    ...
    public void testEmptyValidate() {
        ...
        Assert.assertEquals(BasicValidationVTwo.REQUIRED_FIELD_EMPTY_MSG,
