...
public class SparqlQueryDataGetterTest extends AbstractTestClass {
    ...
    public void setUp() {
        ...
        InputStream in =
            SparqlQueryDataGetterTest.class.getResourceAsStream("resources/dataGetterTest.n3");
        model.read(in, "", "N3");
    ...
    public void testBasicGetData()
        ...
        dataModel.add(ResourceFactory.createResource(bobURI), RDF.type,
        ...
        Assert.assertTrue("people should be a List, it is " + obj.getClass().getName(),
            obj instanceof List);
