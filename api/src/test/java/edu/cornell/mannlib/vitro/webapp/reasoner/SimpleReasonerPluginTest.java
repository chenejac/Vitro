...
public class SimpleReasonerPluginTest extends SimpleReasonerTBoxHelper {
    ...
    private final static String informationResourceInAuthorship_URI =
        VIVOCORE_NS + "informationResourceInAuthorship";
    private final static String linkedInformationResource_URI =
        VIVOCORE_NS + "linkedInformationResource";
    long delay = 50;
    ...
    public void test1() {
        ...
        OntProperty informationResourceInAuthorship =
            tBox.createObjectProperty(informationResourceInAuthorship_URI);
        OntProperty linkedInformationResource =
            tBox.createObjectProperty(linkedInformationResource_URI);
        ...
        try {
            ReasonerPlugin plugin =
                (ReasonerPlugin) Class.forName(pluginClassName).getConstructors()[0].newInstance();
