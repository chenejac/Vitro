...
public class VClassJenaTest extends AbstractTestClass {
    ...
    protected AnnotationProperty LOCAL_SHORTDEF =
    ...
    public void correctValues() {
        ...
        class1.setPropertyValue(ontModel.createProperty(VitroVocabulary.IN_CLASSGROUP),
            ontModel.createResource("http://thisIsTheClassGroupURI"));
        class1.setPropertyValue(ontModel.createProperty(VitroVocabulary.SHORTDEF),
            ontModel.createTypedLiteral("this is the short definition"));
        class1.setPropertyValue(ontModel.createProperty(VitroVocabulary.EXAMPLE_ANNOT),
            ontModel.createTypedLiteral("this is the example"));
        class1.setPropertyValue(ontModel.createProperty(VitroVocabulary.DESCRIPTION_ANNOT),
            ontModel.createTypedLiteral("this is the description"));
        class1.setPropertyValue(ontModel.createProperty(VitroVocabulary.DISPLAY_LIMIT),
            ontModel.createTypedLiteral(-1));
        class1.setPropertyValue(ontModel.createProperty(VitroVocabulary.DISPLAY_RANK_ANNOT),
            ontModel.createTypedLiteral(-11));
        class1.setPropertyValue(ontModel.createProperty(VitroVocabulary.SEARCH_BOOST_ANNOT),
            ontModel.createTypedLiteral(2.4f));
        class1.setPropertyValue(
            ontModel.createProperty(VitroVocabulary.HIDDEN_FROM_DISPLAY_BELOW_ROLE_LEVEL_ANNOT),
            ontModel.createResource("http://vitro.mannlib.cornell.edu/ns/vitro/role#curator"));
        class1.setPropertyValue(
            ontModel.createProperty(VitroVocabulary.PROHIBITED_FROM_UPDATE_BELOW_ROLE_LEVEL_ANNOT),
            ontModel.createResource("http://vitro.mannlib.cornell.edu/ns/vitro/role#selfEditor"));
        class1.setPropertyValue(
            ontModel.createProperty(VitroVocabulary.HIDDEN_FROM_PUBLISH_BELOW_ROLE_LEVEL_ANNOT),
            ontModel.createResource("http://vitro.mannlib.cornell.edu/ns/vitro/role#editor"));
        class1.setPropertyValue(
            ontModel.createProperty(VitroVocabulary.PROPERTY_CUSTOMENTRYFORMANNOT),
            ontModel.createTypedLiteral("this is the custom entry form annotation"));
        class1.setPropertyValue(
            ontModel.createProperty(VitroVocabulary.PROPERTY_CUSTOMDISPLAYVIEWANNOT),
            ontModel.createTypedLiteral("this is the custom display view annotation"));
        class1.setPropertyValue(
            ontModel.createProperty(VitroVocabulary.PROPERTY_CUSTOMSHORTVIEWANNOT),
            ontModel.createTypedLiteral("this is the custom short view annotation"));
        class1.setPropertyValue(
            ontModel.createProperty(VitroVocabulary.PROPERTY_CUSTOMSEARCHVIEWANNOT),
            ontModel.createTypedLiteral("this is the custom search view annotation"));
        ...
        Assert.assertEquals(vClassJena.getHiddenFromDisplayBelowRoleLevel(),
            vClass.getHiddenFromDisplayBelowRoleLevel());
        Assert.assertEquals(vClassJena.getProhibitedFromUpdateBelowRoleLevel(),
            vClass.getProhibitedFromUpdateBelowRoleLevel());
        Assert.assertEquals(vClassJena.getHiddenFromPublishBelowRoleLevel(),
            vClass.getHiddenFromPublishBelowRoleLevel());
    ...
    private VClass vClassWebappFromOntClass(OntClass cls, WebappDaoFactoryJena wadf) {
        ...
        try {
            ...
            try {
                ...
                System.out.println(
                    "error retrieving vitro:inClassGroup property value for " + cls.getURI());
            }
            ...
            vcw.setCustomEntryForm(
                getPropertyStringValue(cls, LOCAL_PROPERTY_CUSTOMENTRYFORMANNOT));
            vcw.setCustomDisplayView(
                getPropertyStringValue(cls, LOCAL_PROPERTY_CUSTOMDISPLAYVIEWANNOT));
            vcw.setCustomShortView(
                getPropertyStringValue(cls, LOCAL_PROPERTY_CUSTOMSHORTVIEWANNOT));
            vcw.setCustomSearchView(
                getPropertyStringValue(cls, LOCAL_PROPERTY_CUSTOMSEARCHVIEWANNOT));
                ...
                if (stmt != null && (obj = stmt.getObject()) != null && obj.isURIResource()) {
                    ...
                    if (res != null && res.getURI() != null) {
                        BaseResourceBean.RoleLevel roleFromModel =
                            BaseResourceBean.RoleLevel.getRoleByUri(res.getURI());
                        if (roleFromModel != null &&
                            (hiddenRoleLevel == null ||
                                roleFromModel.compareTo(hiddenRoleLevel) > 0)) {
                ...
                if (stmt != null && (obj = stmt.getObject()) != null && obj.isURIResource()) {
                    ...
                    if (res != null && res.getURI() != null) {
                        BaseResourceBean.RoleLevel roleFromModel =
                            BaseResourceBean.RoleLevel.getRoleByUri(res.getURI());
                        if (roleFromModel != null &&
                            (prohibitedRoleLevel == null ||
                                roleFromModel.compareTo(prohibitedRoleLevel) > 0)) {
                            prohibitedRoleLevel = roleFromModel;
                        }
                    }
                }
            }
            vcw.setProhibitedFromUpdateBelowRoleLevel(
                prohibitedRoleLevel);//this might get set to null
                ...
                if (stmt != null && (obj = stmt.getObject()) != null && obj.isURIResource()) {
                    ...
                    if (res != null && res.getURI() != null) {
                        BaseResourceBean.RoleLevel roleFromModel =
                            BaseResourceBean.RoleLevel.getRoleByUri(res.getURI());
                        if (roleFromModel != null &&
                            (publishRoleLevel == null ||
                                roleFromModel.compareTo(publishRoleLevel) > 0)) {
                ...
                if (cls.isRestriction()) {
                    ...
                    if (rest.isAllValuesFromRestriction() || rest.isSomeValuesFromRestriction()) {
                        ...
                        if (fillerRes.canAs(OntClass.class)) {
                            ...
                            try {
                                labelStr +=
                                    getLabelOrId((OntResource) fillerRes.as(OntResource.class));
                            } catch (Exception e) {
                                labelStr += "???";
                            }
                        }
                        ...
                        try {
                            if (fillerNode.isResource()) {
                                labelStr +=
                                    getLabelOrId((OntResource) fillerNode.as(OntResource.class));
                            } else {
                                labelStr +=
                                    ((Literal) fillerNode.as(Literal.class)).getLexicalForm();
                            }
                        } catch (Exception e) {
                            labelStr += "???";
                        }
                    ...
                    if (cls.isComplementClass()) {
                        ...
                        labelStr.append(
                            getLabelForClass(ccls.getOperand(), withPrefix, forPickList, wadf));
                    } else if (cls.isIntersectionClass()) {
                        IntersectionClass icls =
                            (IntersectionClass) cls.as(IntersectionClass.class);
                        for (Iterator operandIt = icls.listOperands(); operandIt.hasNext(); ) {
                            OntClass operand = (OntClass) operandIt.next();
                            labelStr
                                .append(getLabelForClass(operand, withPrefix, forPickList, wadf));
                    ...
                    return "<a href=\"vclassEdit?uri=" +
                        URLEncoder.encode(getClassURIStr(cls), "UTF-8") +
                        "\">[anonymous class]</a>";
                }
            } else {
    ...
    protected String getLabel(OntResource r) {
        ...
        try {
            ...
            if (label == null) {
                label = tryPropertyForPreferredLanguages(r,
                    r.getModel().getProperty(VitroVocabulary.label), ALSO_TRY_NO_LANG);
            }
        } finally {
            r.getOntModel().leaveCriticalSection();
        }
    ...
    private String tryPropertyForPreferredLanguages(OntResource r, Property p,
                                                    boolean alsoTryNoLang) {
        String label = null;
    ...
    protected String getPropertyStringValue(OntResource res, Property dataprop) {
        if (dataprop != null) {
            try {
                ClosableIterator stateIt =
                    res.getModel().listStatements(res, dataprop, (Literal) null);
                try {
                    if (stateIt.hasNext()) {
