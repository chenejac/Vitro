...
public class PropertyInstanceDaoJenaTest extends AbstractTestClass {
    ...
    public void testStmtNonForceDelete() {
        ...
        wdf.getPropertyInstanceDao()
            .deleteObjectPropertyStatement("http://example.com/bob", "http://example.com/hasNose",
                "http://example.com/nose1");
        ...
        if (!same) {
            printModels(expectedModel, ontModel.getBaseModel());
        }
    ...
    public void testGetAllPossiblePropInstForIndividual() {
        ...
        Assert
            .assertEquals("http://example.com/Mold", propToRange.get("http://example.com/hasMold"));
        Assert.assertEquals("http://example.com/Organism",
            propToRange.get("http://example.com/hasSpore"));
        Assert.assertEquals("http://example.com/Fungus",
            propToRange.get("http://example.com/hasFungus"));
