...
public class ResourceAPIPoolTest extends ServletContextTest {
    ...
    protected final static String TEST_PERSON_RESOURCE_API_URI = "https://vivoweb.org/ontology/vitro-dynamic-api/resourceAPI/testPersonResource1";
    ...
    public void testGetBeforeInit() {
        ResourceAPIPool resourceAPIPool = ResourceAPIPool.getInstance();
        assertTrue(resourceAPIPool.get(TEST_RESOURCE_API_KEY) instanceof DefaultResourceAPI);
    }
    ...
    public void testInit() throws IOException {
        ...
        assertResourceAPI(TEST_RESOURCE_API_KEY, TEST_ACTION_NAME, resourceAPIPool.get(TEST_RESOURCE_API_KEY));
    }
    ...
    public void testVersioning() throws IOException {
        ...
        ResourceAPIKey expectedPerson_v1_0_0 = TEST_PERSON_RESOURCE_API_KEY; // "test_person_resource", "1.0.0"
        ...
        assertResourceAPI(TEST_RESOURCE_API_KEY, TEST_ACTION_NAME, resourceAPIPool.get(resouce_v0));
        assertResourceAPI(TEST_RESOURCE_API_KEY, TEST_ACTION_NAME, resourceAPIPool.get(resource_v1));
        ...
        // demonstrate no person resources in resourceAPI pool
        ...
        // base test for test_document
        assertTrue(resourceAPIPool.get(document_v0) instanceof DefaultResourceAPI);
        assertResourceAPI(expectedDocument_v1_0_0, testDocumentActionName, resourceAPIPool.get(document_v1));
        ...
        assertResourceAPI(expectedPerson_v1_0_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v1));
        assertResourceAPI(expectedPerson_v1_0_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v2));
        assertResourceAPI(expectedPerson_v1_0_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v3));
        assertResourceAPI(expectedPerson_v1_0_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v4));
        assertResourceAPI(expectedPerson_v1_0_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v5));
        ...
        assertResourceAPI(expectedPerson_v1_0_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v1_0));
        assertResourceAPI(expectedPerson_v1_0_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v1_0_0));

        // able to get person version 1.1.0 from varying levels of specificity
        assertResourceAPI(expectedPerson_v1_1_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v1));
        assertResourceAPI(expectedPerson_v1_1_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v1_1));
        assertResourceAPI(expectedPerson_v1_1_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v1_1_0));
        ...
        assertResourceAPI(expectedPerson_v1_1_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v2));
        assertResourceAPI(expectedPerson_v1_1_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v3));
        assertResourceAPI(expectedPerson_v1_1_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v4));
        assertResourceAPI(expectedPerson_v1_1_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v5));
        ...
        assertResourceAPI(expectedDocument_v1_0_0, testDocumentActionName, resourceAPIPool.get(document_v1));
         ...
         assertResourceAPI(expectedPerson_v2_0_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v2));

         // person resource version 2.0.0 has no max version, any major version request greater than 2 should return version 2.0.0
         assertResourceAPI(expectedPerson_v2_0_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v3));
         assertResourceAPI(expectedPerson_v2_0_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v4));
         assertResourceAPI(expectedPerson_v2_0_0, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v5));
        ...
        assertResourceAPI(expectedPerson_v4_3_7, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v4));
        assertResourceAPI(expectedPerson_v4_3_7, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v4_3));
        assertResourceAPI(expectedPerson_v4_3_7, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v4_3_7));

        // person resource version 4.3.7 has no max version, any major version request greater than 4 should return version 2.0.0
        assertResourceAPI(expectedPerson_v4_3_7, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(person_v5));
    }
    ...
    public void testAdd() throws IOException, ConfigurationBeanLoaderException {
        ...
        ResourceAPI resourceAPI = loader.loadInstance(TEST_PERSON_RESOURCE_API_URI, ResourceAPI.class);

        resourceAPIPool.add(TEST_PERSON_RESOURCE_API_URI, resourceAPI);

        assertEquals(0, resourceAPIPool.obsoleteCount());

        assertResourceAPI(TEST_PERSON_RESOURCE_API_KEY, TEST_PERSON_ACTION_NAME, resourceAPIPool.get(TEST_PERSON_RESOURCE_API_KEY));
    }
    ...
    public void testAddHasClient() throws IOException, ConfigurationBeanLoaderException {
        ...
        ResourceAPI resourceAPIHasClient = resourceAPIPool.get(TEST_PERSON_RESOURCE_API_KEY);
    ...
    public void testAddWithoutModelLoaded() throws IOException, ConfigurationBeanLoaderException {
        ...
        assertTrue(resourceAPIPool.get(TEST_PERSON_RESOURCE_API_KEY) instanceof DefaultResourceAPI);
    ...
    public void testRemove() throws IOException, ConfigurationBeanLoaderException {
        ...
        ResourceAPI resourceAPI = resourceAPIPool.get(TEST_PERSON_RESOURCE_API_KEY);
        ...
        resourceAPIPool.remove(TEST_PERSON_RESOURCE_API_URI, TEST_PERSON_RESOURCE_API_KEY);
    ...
    public void testReloadSingle() throws IOException {
        ...
        resourceAPIPool.reload(TEST_PERSON_RESOURCE_API_URI);
    ...
    @Test
    public void testRealodOfResourceAPIHasClient() throws IOException {
        ResourceAPIPool resourceAPIPool = initWithDefaultModel();

        loadTestModel();

        ResourceAPI resourceAPI = resourceAPIPool.get(TEST_RESOURCE_API_KEY);

        CompletableFuture<Void> reloadFuture = CompletableFuture.runAsync(() -> resourceAPIPool.reload());

        while (!reloadFuture.isDone()) {
            assertEquals(TEST_RESOURCE_API_KEY, resourceAPI.getKey());
        }
    ...
    public void testClientsManagement() throws IOException, InterruptedException {
        ...
        Thread t1 = getResourceAPIInThread(resourceAPIPool, TEST_RESOURCE_API_KEY);
    ...
    private Thread getResourceAPIInThread(ResourceAPIPool resourceAPIPool, ResourceAPIKey resourceAPIKey) {
    ...
    private void assertResourceAPI(ResourceAPIKey expctedResourceAPIKey, String expectedActionName, ResourceAPI actualResourceAPI) {
