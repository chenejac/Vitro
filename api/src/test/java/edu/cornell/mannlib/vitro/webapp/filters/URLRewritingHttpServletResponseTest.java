...
public class URLRewritingHttpServletResponseTest {
    ...
    protected void urlEncodingStyleA(String urlToEncode, String expectedUrlResult) {
        URLRewritingHttpServletResponse urhsr = new URLRewritingHttpServletResponse(
            new stubs.javax.servlet.http.HttpServletResponseStub());
    ...
    public void test40984() {
        urlEncodingStyleA("/vivo/js/jquery-1.12.4.min.js",
    ...
    public void test40996() {
        urlEncodingStyleA("/vivo/js/controls.js",
            "/vivo/js/controls.js");
    }
    ...
    public void test18506() {
        urlEncodingStyleA("/vivo/individual?uri=",
            "/vivo/individual?uri=");
    }
    ...
    public void test14561() {
        urlEncodingStyleA("/vivo/admin/sparqlquery",
    ...
    public void test35560() {
        urlEncodingStyleB("/js/jquery-1.12.4.min.js",
    ...
    public void test35617() {
        urlEncodingStyleB("/js/controls.js",
            "/js/controls.js");
    }
