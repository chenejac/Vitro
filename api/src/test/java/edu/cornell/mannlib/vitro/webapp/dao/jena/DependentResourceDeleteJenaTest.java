...
public class DependentResourceDeleteJenaTest extends AbstractTestClass {
    ...
    public void testStmtSimpleForceDelete() {
        ...
        Model model = (ModelFactory.createDefaultModel()).read(new StringReader(n3), "", "N3");
        Model expectedModel =
            (ModelFactory.createDefaultModel()).read(new StringReader(expected), "", "N3");
    ...
    public void testStmtNonForceDelete() {
        ...
        if (!same) {
            printModels(expectedModel, model);
        }
    ...
    public void testStmtForceDeleteWithBNodes() {
        ...
        List<Statement> deletes =
            DependentResourceDeleteJena
                .getDependentResourceDeleteList(stmtIt.nextStatement(), model);
        model.remove(deletes);
...
//    }
    ...
    public void testDeleteForChange() {
        ...
        Model sourceModel =
            (ModelFactory.createDefaultModel()).read(new StringReader(source), "", "N3");
        Model additionsModel = (ModelFactory.createDefaultModel()); //no additions
        Model retractionsModel =
            (ModelFactory.createDefaultModel()).read(new StringReader(retractions), "", "N3");

        Model deletes =
            DependentResourceDeleteJena
                .getDependentResourceDeleteForChange(additionsModel, retractionsModel, sourceModel);
        ...
        if (!same) {
            printModels(expectedModel, sourceModel);
        }
        Assert.assertTrue(same);
    }
    ...
    public void testDeleteForChangeWithReplace() {
        ...
        Model additionsModel =
            (ModelFactory.createDefaultModel()).read(new StringReader(additions), "", "N3");
        Model retractionsModel =
            (ModelFactory.createDefaultModel()).read(new StringReader(retractions), "", "N3");
