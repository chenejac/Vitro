...
public class QueryHolderTest extends AbstractTestClass {
    ...
    private static final String FIND_TWICE =
        "CONSTRUCT { ?s ?p ?find_twice } WHERE { ?s ?p ?find_twice }";
    ...
    private static final String FIND_IN_SELECT_CLAUSE =
        "SELECT ?s ?p ?bindMe WHERE { ?s ?p ?bindMe }";
