...
public abstract class ServletContextTest {
    ...
    protected final static ResourceAPIKey TEST_RESOURCE_API_KEY = ResourceAPIKey.of("test_resource", "0.1.0");

    protected final static String TEST_PERSON_ACTION_NAME = "test_person";
    protected final static ResourceAPIKey TEST_PERSON_RESOURCE_API_KEY = ResourceAPIKey.of("test_person_resource", "1.0.0");
