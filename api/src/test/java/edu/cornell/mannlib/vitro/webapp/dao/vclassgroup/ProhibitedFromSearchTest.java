...
public class ProhibitedFromSearchTest {
    ...
    String n3 =
        "@prefix : <http://vitro.mannlib.cornell.edu/ns/vitroDisplay#> . \n" +
            ...
            "           <" + DisplayVocabulary.EXCLUDE_CLASS.getURI() +
            "> vivo:Class2, vivo:Class3, vivo:Class4, <" + TEST_CLASS + "> .\n";
    ...
    public void testListener() {
        ...
        Resource bougsClass4 =
            ResourceFactory.createResource("http://vivoweb.org/ontology/test/bogus#Class4");
    ...
    public void testPrimaryIndex() {
        ...
        Model r =
            ModelFactory.createDefaultModel().read(new StringReader(primaryIndexN3), null, "N3");
        OntModel m = ModelFactory.createOntologyModel(OntModelSpec.OWL_MEM);
        m.add(r.listStatements());
        ...
        Assert.assertTrue(
            pfs.isClassProhibitedFromSearch("http://vivoweb.org/ontology/core#NonAcademic"));
        Assert.assertTrue(!pfs.isClassProhibitedFromSearch("http://someOtherClass.com/test"));
    }
}
