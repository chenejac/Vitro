...
public class ConfigurationBeanLoaderTestBase extends AbstractTestClass {
    ...
    protected static final String SIMPLE_SUCCESS_INSTANCE_URI =
        "http://mytest.edu/simple_success_instance";

    protected static final String FULL_SUCCESS_INSTANCE_URI =
        "http://mytest.edu/full_success_instance";
    ...
    protected static final String FULL_SUCCESS_HELPER_INSTANCE_URI =
        "http://mytest.edu/full_success_helper_instance";
