...
public class VitroURLTest {
    ...
    public void testToString() {
        String MelbUniStr =
            "/entity?home=1&uri=HTTPS://bida.themis.unimelb.edu.au/pls/apex/f?p=mrw2rdf:org:::::org_id:145";
        VitroURL instance = new VitroURL(MelbUniStr, "UTF-8");
        String expResult =
            "/entity?home=1&uri=HTTPS%3A%2F%2Fbida.themis.unimelb.edu.au%2Fpls%2Fapex%2Ff%3Fp%3Dmrw2rdf%3Aorg%3A%3A%3A%3A%3Aorg_id%3A145";
        String result = instance.toString();
        assertEquals(expResult, result);

        String defaultTestStr =
            "/entity?home=1&uri=http://aims.fao.org/aos/geopolitical.owl#Afghanistan";
        instance = new VitroURL(defaultTestStr, "UTF-8");
        expResult =
            "/entity?home=1&uri=http%3A%2F%2Faims.fao.org%2Faos%2Fgeopolitical.owl%23Afghanistan";
    ...
    public void testParseQueryParams() {
        ...
        List<String[]> result = instance.parseQueryParams(
            "uri=HTTPS://bida.themis.unimelb.edu.au/pls/apex/f?p=mrw2rdf:org:::::org_id:145");
        ...
        Assert.assertEquals(
            "HTTPS://bida.themis.unimelb.edu.au/pls/apex/f?p=mrw2rdf:org:::::org_id:145",
            result.get(0)[1]);
    }
    ...
    public void testParseQueryParams2() {
        ...
        VitroURL instance = new VitroURL("stringNotImportant", "UTF-8");
        List<String[]> result = instance.parseQueryParams(
            "home=1&uri=HTTPS://bida.themis.unimelb.edu.au/pls/apex/f?p=mrw2rdf:org:::::org_id:145");
        Assert.assertNotNull(result);
    ...
    public void testParseQueryParams3() {
        //parseQueryParams
        VitroURL instance = new VitroURL("stringNotImportant", "UTF-8");
        List<String[]> result = instance
            .parseQueryParams("home=1&uri=HTTPS://bida.edu.au/pls/apex/f?p=mrw2&additiona=234");
        Assert.assertNotNull(result);
        Assert.assertEquals(2, result.size());
        ...
        Assert.assertEquals("uri", result.get(1)[0]);
        Assert
            .assertEquals("HTTPS://bida.edu.au/pls/apex/f?p=mrw2&additiona=234", result.get(1)[1]);
    }
    ...
    public void testParseQueryParams4() {
        ...
        VitroURL instance = new VitroURL("stringNotImportant", "UTF-8");
        List<String[]> result = instance.parseQueryParams(
            "home=1&shouldBeURI=HTTPS://bida.edu.au/pls/apex/f?p=mrw2&additiona=234");
        Assert.assertNotNull(result);
        Assert.assertEquals(2, result.size());
